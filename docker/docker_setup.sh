...
function run (){
    ...
    docker run -d --name VREPContainer -it -e DISPLAY=$DISPLAY -v /tmp/.X11-unix:/tmp/.X11-unix:rw -v ${PWD%/*}:/home/user/workspace/src/coppeliasim:rw --net=host --privileged --runtime=nvidia vrep_image:latest
}
